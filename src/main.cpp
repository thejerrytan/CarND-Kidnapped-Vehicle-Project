              ...
              if (length && length > 2 && data[0] == '4' && data[1] == '2') {
                ...
                if (s != "") {
                  ...
                  if (event == "telemetry") {
                    ...
                    cout << "time taken for predict " << (end1 - start1).count() << endl;
                    ...
                    cout << "time taken for updateWeights " << (end2 - start2).count() << endl;
                    cout << "time taken for resample " << (end3 - end2).count() << endl;
                    cout << "time taken for bestParticle" << (end4 - end3).count() << endl;
